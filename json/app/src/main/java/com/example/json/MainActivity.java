...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetWeatherInfo extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(MainActivity.this, contactList, R.layout.list_view, new String[]{"id", "name", "email", "mobile"}, new int[]{R.id.id, R.id.name, R.id.email, R.id.mobile});
